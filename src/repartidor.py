...
class Repartidor:
    ...
    def update(self, dt, clima, en_parque):
        ...
        if self.is_moving:
            ...
            dx, dy = self.target_px - self.px, self.target_py - self.py
            ...
            if distance < move_dist:
                ...
                self.is_moving = False
                self.tile_x, self.tile_y = int(self.px // self.tile_size), int(self.py // self.tile_size)
                self.actualizar_imagen()
            else:
    ...
    def __getstate__(self):
        ...
        for key in ['sprites', 'imagen', 'rect']:
